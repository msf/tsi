...
extern int srchsupr(float *, float *, float *, float *, int *, int *, double *, int *, int *, int 
...
extern int krige(int *, int *, int *, float * , float *, float *,
		int *, float *, float *, float *, const float *, float *,
		general_vars_t *,
		search_vars_t *,
		simulation_vars_t *,
		covariance_vars_t *,
...
extern int setrot(float *, float *, float *, float *, float *
			, int *, int *, double *);
extern int sortem(int *, int *, float *, int *, int *, float *, float *, float *,
			   float *, float *, float *);
